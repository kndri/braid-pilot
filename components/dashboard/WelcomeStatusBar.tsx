...
export function WelcomeStatusBar({ salonName, isOnline }: WelcomeStatusBarProps) {
  if (!isOnline) {
    return (
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-800">
                Your setup is almost complete! Finish the Onboarding Wizard to get your quote tool live.
              </p>
            </div>
          </div>
          <Link
